      ...
      <footer class="bg-white w-full py-8">
        <div class="max-w-screen-xl px-4 mx-auto">
          <ul class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
            <li class="my-2">
              <a
                class="text-gray-500 hover:text-gray-800 font-normal transition-colors duration-200"
                href="#"
              >
                FAQ
              </a>
          ...
          <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
            <a
              href="#"
              class="text-gray-600 transition-colors duration-200 hover:text-green-400 "
            >
              <svg
                width="20"
                height="20"
            ...
            <a
              href="#"
              class="text-gray-600 transition-colors duration-200 hover:text-gray-800 "
            >
              <svg
                width="20"
                height="20"
                fill="currentColor"
                class="text-xl transition-colors duration-200 hover:text-blue-400 "
                viewBox="0 0 1792 1792"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                ...
                height="20"
                fill="currentColor"
                class="text-xl transition-colors duration-200 hover:text-blue-800"
                viewBox="0 0 1792 1792"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                ...
                height="20"
                fill="currentColor"
                class="text-xl transition-colors duration-200 hover:text-orange-500 "
                viewBox="0 0 1792 1792"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            <form class="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
              ...
              <button
                class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-green-600 rounded-lg shadow-md hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-purple-200"
                type="submit"
              >
                Subscribe
              </button>
          ...
          <div class="text-center text-slate-600  pt-10 sm:pt-12 font-bold flex items-center justify-center">
            Created by MUKESH
          </div>
        </div>
      </footer>
